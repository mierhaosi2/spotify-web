...
import blueImg from '@/labs/glass/assets/background/blue.jpg'
import beautifulImg from '@/labs/glass/assets/background/big-beautiful.png'
        ...
        <section className="section section-panel">
          ...
          <div className="grid">
            <div className="card tall">
              <div className="preview no-pad">
                <GlassNotification
                  wallpaper={`url(${blueImg}) center/cover no-repeat`}
                />
              </div>
              <div className="card-info">
                <h3>通知卡片</h3>
            ...
            <div className="card tall">
              <div className="preview no-pad">
                <GlassContextMenu
                  wallpaper={`url(${beautifulImg}) center/cover no-repeat`}
                />
              </div>
              <div className="card-info">
                <h3>右键菜单</h3>
